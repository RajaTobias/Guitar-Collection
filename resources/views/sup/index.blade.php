                                ...
                                @foreach ($datas as $data)
                                        <tr>
                                            ...
                                            <td class = "form-inline">
                                                ...
                                                <a href="{{ route('sup.delete', $data->ID_SUPPLIER) }}" onclick="return confirm('{{ __('Are you sure you want to delete?') }}')" type="button" class="ml-1 btn btn-danger rounded-3"></>Destroy</a>
